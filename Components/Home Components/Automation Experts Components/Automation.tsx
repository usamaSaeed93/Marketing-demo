  ...
  return (
    <>
      <div className="automation__main flex flex-col px-4 py-4 mx-2">
        ...
        <div className="grid  grid-cols-1 xsm:grid-cols-2 sm:gap-4 gap-2 md:grid-cols-2 lg:grid-cols-4 py-2 px-4 m-auto ">
