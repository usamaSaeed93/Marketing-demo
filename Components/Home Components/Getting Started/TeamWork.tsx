...
export default function TeamWork() {
  ...
  return ( 
    ...
    <div className='background flex flex-col max-w-[288px] h-80 w-full  gap-2 justify-center items-center bg-cover bg-center bg-no-repeat  rounded-[21px] border-3 border-solid border-[#EFEFEF] bg-white shadow-xl ' >
<Image 
src={middle}
alt='middle'
width={140}
