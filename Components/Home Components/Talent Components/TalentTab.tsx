...
export default function TalentTab() {
  const stars = Array(5).fill(
    <StarIcon className="text-sm sm:text-3xl text-[#FFC226]" />
  );
  return (
    <div className="max-w-[450px] max-h-fit min-w-[320px] m-4 sm:m-0 rounded-[22px] border border-[#000] border-solid flex flex-col items-center border-opacity-10 ">
      ...
      <div className="relative bottom-24 sm:bottom-30 items-center justify-center object-cover w-11/12 m-auto">
        ...
        />
        <p className="font-bold text-3xl sm:text-4xl text-center font-space">
          Adam
        </p>
        <p className="text-lg sm:text-2xl font-normal text-center m-auto font-space">
        ...
        <div className="  flex flex-col gap-3 mt-3 p-2">
          <div className="flex flex-row sm:gap-20 md:gap-10 lg:gap-20 gap-0 items-between justify-between">
            <span className="text-base sm:text-large font-space ">Salary</span>
        ...
        <div className="flex flex-row justify-between items-center">
          <Image src={seventy1} alt="adobe" />
          <Image src={seventy2} alt="adobe" />
          <Image src={seventy3} alt="adobe" />
        </div>
      </div>
    </div>
  );
